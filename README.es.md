...
Skill especializada para operaciones de **osint** en entornos multiagente (OpenClaw/KiloCode).

## Descripción general

Abyss Scanner permite ejecutar tareas de osint con un flujo seguro, reproducible y trazable.

## Cuándo usar

- Necesitas ejecución estructurada en el dominio **osint**.
...
- Activación por triggers para escenarios de osint.
...
**Input:** "Audita y mejora el flujo de osint."
