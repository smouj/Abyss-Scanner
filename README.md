...
Specialized skill for **osint** operations in multi-agent environments (OpenClaw/KiloCode).

## Overview

Abyss Scanner helps execute osint tasks with a secure, repeatable, and audit-friendly workflow.

## When to use

- You need structured execution in the **osint** domain.
- You want reproducible outputs (plan, verification, rollback).
- You need explicit safety guardrails and operator control.

## Core capabilities

- Trigger-based activation for osint scenarios.
...
**Input:** "Audit and improve osint workflow."
